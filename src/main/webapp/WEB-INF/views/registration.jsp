 	...
 	<div class="generic-container">
		...
		<div class="well lead">User Registration Form</div>
	 	<form:form method="POST" modelAttribute="user" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="dataDiNascita">Data di nascita</label>
					<div class="col-md-7">
						<form:input type="text" path="dataDiNascita" id="dataDiNascita" class="form-control input-sm" />
						<div class="has-error">
							<form:errors path="dataDiNascita" class="help-inline"/>
						</div>
					</div>
				</div>
			</div>
...
<script>
	$(document).ready(function(){
		var date_input=$('input[name="dataDiNascita"]'); //our date input has the name "date"
